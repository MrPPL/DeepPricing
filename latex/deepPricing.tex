...
The concepts for option pricing theory is presented and closed form solutions is provided in special cases. The options with no closed form solution is investigated through numerical methods, where both the binomial lattice model and LSM will be presented assuming the underlying Black-Scholes theory. Deep learning is then investigate to look for improvement of the existing models, where we look specifically at the MLPs regression.
\end{abstract}
