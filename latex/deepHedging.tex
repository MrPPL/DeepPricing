...
\thesistitle{Deep hedging} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\textbf{FPT1} & \textbf{F}undamental \textbf{P}ricing \textbf{T}heorem I\\
\textbf{FPT2} & \textbf{F}undamental \textbf{P}ricing \textbf{T}heorem II\\
...
$W_t$ & Weiner process (a synonym brownian motion).\\
