...
The first step for MLP is building the network, where we begin with zooming in on a single neuron, which is one node of the directed acyclic graph (figure \ref{fig:multilayer-perceptron}).
...
With an understanding of a single neuron, we continue to the architecture of a MLP.
