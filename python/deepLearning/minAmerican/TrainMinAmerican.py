...
# prepare the dataset
####################
def prepare_data(dataPath, batchsize):
    # calculate split
...
#prepare data
dataPath = "./deepLearning/minAmerican/data/100KCAmerMinPut.csv"
dataset = Dataset(dataPath)
batchSize = 64
train_dl, valid_dl, test_dl = prepare_data(dataPath,batchSize)
print(len(train_dl.dataset), len(valid_dl))
#define network
#hyperparameters
