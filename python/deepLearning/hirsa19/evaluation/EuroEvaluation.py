...
# get dataset
###################
test_dataset = EuroParDataset("./deepLearning/hirsa19/data/outMoneyEuroCData.csv")
...
loaded_model.load_state_dict(torch.load("/home/ppl/Documents/Universitet/KUKandidat/Speciale/DeepHedging/python/deepLearning/Models/hirsaModel.pth"))
loaded_model.eval()
...
#plt.savefig("/home/ppl/Documents/Universitet/KUKandidat/Speciale/DeepHedging/latex/Figures/PredictionOutMoneyEuroC.png")
plt.show()
