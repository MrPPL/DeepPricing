...
# create dataset
dataset = EuroParDataset("./deepLearning/hirsa19/data/mediumPAmerData.csv")
...
# save model
################
torch.save(model.state_dict(), "/home/ppl/Documents/Universitet/KUKandidat/Speciale/DeepHedging/python/deepLearning/Models/hirsaAmerModel.pth")
...
plt.title("American Put: Multilayer Perceptrons Predictions Vs. Actual Targets")
...
#plt.savefig("/home/ppl/Documents/Universitet/KUKandidat/Speciale/DeepHedging/latex/Figures/PredictionAmerP.png")
plt.show()
